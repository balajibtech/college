...
<form name="adminEditProfile" method="POST" action="php/updateAdminProfile.php"  onsubmit="return editStaffProfileDetails()">
...
<table align="center">
	<tr>
		...
		{/if}
		{if $message=="invalid"}
			<div class="errorMessage">No Changes Made On Staff Details!</div>
		{/if}
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="text" name="userName" id="userName" onkeyup="whiteSpace(event,'userName')" onblur="lengthValidate('userName','User Name')" value='{$user.user_name}' readonly>
		</td>
	</tr>
...
value='no' checked><label class="labelText">No</label>
	...
	<tr>
		...
		<td>
			<input type="text" name="designation" id="designation" onblur="nullValidate('designation','Ur Designation')" value='{$user.user_designation}'>
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="text" value='{$user.dob}' readonly name="dob" id="dob"><input type="button" value="Cal" onclick="displayCalendar(document.forms[0].dob,'yyyy-mm-dd',this)">
		</td>
	</tr>
