...
<form name="editStudentProfile" method="POST" enctype="multipart/form-data" action="php/editStudent.php?userTypeName=student&operation=edit" onsubmit="return editStudentProfileAdmin()">
...
<table align="center">
	...
	<tr>
		...
		<td>
			<input type="text" name="userName" id="userName" onkeyup="whiteSpace(event,'userName')" onblur="lengthValidate('userName','User Name')" value='{$staff.user_name}'>
		</td>
	</tr>
...
value='no' checked><label class="labelText">No</label>
	...
	<tr>
		...
		<td>
			<input type="text" name="designation" id="designation" onblur="nullValidate('designation','Ur Designation')" value="Student" readonly>
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			...
			{html_options values=$dobYear selected=$staff.student_batch output=$dobYear}</select>
		</td>
	</tr>
	...
	<tr>
		<td align="right">
			<input type="submit" value="Create Student Account" style="display:block" name="createStudentAccount" ></td><td>&nbsp;
...
<input type="hidden" name="studentId" value='{$staff.user_id}'>
