{if $loginTypeId=='2'}
<div class="heading">VIEW SUBJECT DETAILS</div>
...
<table align="center">
	<tr>
		...
		<td>
			<select name="batch" id="batch" name="batch">{html_options values="" output=Select}
	...
	<tr>
		<td colspan='2' align='center'><input type="button" value="VIEW SUBJECT" onclick="viewSubjectDetails()">
		</td>
	</tr>
</table>
